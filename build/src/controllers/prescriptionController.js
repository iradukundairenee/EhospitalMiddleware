...
exports.getPrescriptionById = exports.getAllPrescriptions = exports.downloadPrescription = exports.createPrescription = void 0;
...
const downloadPrescription = (0, _catchAsync.catchAsync)(async (req, res) => {
  const {
    id
  } = req.params;
  const prescription = prescriptions.find(p => p.id === parseInt(id));
